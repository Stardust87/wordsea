<div class=" m-auto w-full md:w-1/2">
	...
	<p class="mb-3 text-lg text-gray-500 md:text-xl dark:text-gray-400">
		...
		yet still struggled to fully grasp their meanings?
	</p>
	<p class="text-gray-500 dark:text-gray-400">
		We've been there too. That's why we created
		<span
			class="group text-slate-600 hover:text-slate-800 dark:text-slate-400 hover:dark:text-slate-300"
		>
			<a href="https://github.com/Stardust87/wordsea">
				<span class="underline">WordSea</span>
				<svg
		...
		- an innovative app designed to enrich your vocabulary by presenting visualizations alongside
		definitions.
	</p>
	...
	<p
		class="mt-4 bg-gradient-to-r from-cyan-500 to-emerald-800 bg-clip-text font-semibold text-transparent drop-shadow-lg dark:from-cyan-400 dark:to-emerald-700"
	>
